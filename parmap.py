...
def parmap(f, iterable, nprocs=multiprocessing.cpu_count(), show_progress=True, size=None):
	"""
	@param f
...
if __name__ == "__main__":
	import time
	print(parmap(lambda x: (x, time.sleep(1))[0], range(10), show_progress=True, nprocs=2))
	print(parmap(lambda x: (x, time.sleep(1))[0], range(30), show_progress=False))
